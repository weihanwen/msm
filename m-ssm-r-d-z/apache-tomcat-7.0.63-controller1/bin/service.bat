...
if exist "%CATALINA_HOME2%\bin\tomcat7.exe" goto okHome
...
set "EXECUTABLE=%CATALINA_HOME2%\bin\tomcat7.exe"
...
"%EXECUTABLE%" //IS//%SERVICE_NAME% ^
    ...
    --StartParams start ^
    --StopParams stop ^
    --JvmOptions "-Dcatalina.home=%CATALINA_HOME2%;-Dcatalina.base=%CATALINA_BASE%;-Djava.endorsed.dirs=%CATALINA_HOME2%\endorsed;-Djava.io.tmpdir=%CATALINA_BASE%\temp;-Djava.util.logging.manager=org.apache.juli.ClassLoaderLogManager;-Djava.util.logging.config.file=%CATALINA_BASE%\conf\logging.properties" ^
    --JvmMs 128 ^
    --JvmMx 256
